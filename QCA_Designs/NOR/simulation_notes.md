# QCA NOR Gate: Simulation Notes & Verification Protocol
...
2. Select **File $\to$ Open** and load:
   `c:\Users\sekhm\Desktop\HE-QCA-Project\QCA_Designs\NOR\NOR.qca`
3. Inspect the 7-cell structure:
   - Majority OR core at $(100, 100)$ with inputs $A, B$ and fixed $+1.00$.
...
6. Examine the generated waveform traces:
   ...
   - Trace 3 (`Y`): Evaluated NOR output polarization waveform.
